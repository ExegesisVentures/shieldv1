...
// Icon components for providers that don't have lucide icons
const DiscordIcon = () => (
...
interface Provider {
  ...
  enabled: boolean; // Set to false until configured in Supabase
}
  ...
  const handleSocialLogin = async (provider: string) => {
    ...
    try {
      ...
      if (error) {
        ...
        alert(`Failed to sign in with ${provider}. This provider may not be configured yet.`);
      }
    } catch (error) {
